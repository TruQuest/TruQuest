...
internal class Validator : AbstractValidator<GetThingsListQuery>
{
    public Validator()
    {
...
public class GetThingsListQueryHandler : IRequestHandler<GetThingsListQuery, HandleResult<GetThingsListResultVm>>
{
