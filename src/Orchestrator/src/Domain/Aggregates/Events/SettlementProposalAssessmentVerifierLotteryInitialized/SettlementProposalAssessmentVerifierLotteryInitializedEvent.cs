...
public class SettlementProposalAssessmentVerifierLotteryInitializedEvent : Entity, IAggregateRoot
{
    ...
    public SettlementProposalAssessmentVerifierLotteryInitializedEvent(
