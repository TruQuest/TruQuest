...
public class ThingValidationVerifierLotteryDeploymentMessage : ContractDeploymentMessage
{
    ...
    public ThingValidationVerifierLotteryDeploymentMessage() : base(Bytecode) { }
}
