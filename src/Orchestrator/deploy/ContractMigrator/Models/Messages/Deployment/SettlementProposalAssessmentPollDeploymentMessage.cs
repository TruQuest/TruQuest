...
public class SettlementProposalAssessmentPollDeploymentMessage : ContractDeploymentMessage
{
    ...
    public SettlementProposalAssessmentPollDeploymentMessage() : base(Bytecode) { }
}
