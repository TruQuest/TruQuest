...
import 'package:contained_tab_bar_view/contained_tab_bar_view.dart'
    show TabBarProperties, TabBarViewProperties, TabBarAlignment, TabBarPosition;
...
class ContainedTabBarViewState extends State<ContainedTabBarView> with SingleTickerProviderStateMixin {
    ...
    _controller = TabController(
      ...
      initialIndex: widget.initialIndex,
        ...
        if (widget.callOnChangeWhileIndexIsChanging ||
            (!widget.callOnChangeWhileIndexIsChanging && !_controller.indexIsChanging)) {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) => _buildFlex(constraints),
    );
  }
  ...
  Widget _buildTabBarView(BoxConstraints constraints) {
    final EdgeInsets margin = widget.tabBarProperties.margin.resolve(TextDirection.ltr);
