...
class _PollState extends StateX<Poll> {
  ...
  late Future<AssessmentPollInfoVm?> _infoRetrieved;
                          ...
                          child: Row(
                            children: [
                              ClippedRect(
                                ...
                                child: Text(
                                  result.proposalState == SettlementProposalStateVm.verifiersSelectedAndPollInitiated
                                      ? 'Poll in progress'
                                      : 'Poll finalized',
                              ...
                              if (result.voteAggIpfsCid == null)
                                ...
                                InkWell(
                                  onTapDown: (details) => showOverlay(
                                    ...
                                    title: 'Assessment poll aggregate vote',
                                    urlText: 'See on IPFS...',
                              ...
                              IconButton(
                                ...
                                onPressed: () => _settlementBloc.dispatch(GetVotes(proposalId: widget.proposal.id)),
                              ),
                            ],
                          ),
                        ),
